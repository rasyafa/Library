...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="dashboard.php">LIBRA TECH</a></h1>
        <ul>
           <li><a href="dashboard.php">Dashboard</a></li>
           <li><a href="profil.php">Profile</a></li>
           <li><a href="data-image.php">Book Data</a></li>
           <li><a href="Keluar.php">Sign Out</a></li>
        </ul>
        </div>
    </header>
            ...
            <div class="box">
               ...
               <form action="" method="POST" enctype="multipart/form-data">
                   ...
                   <?php   $result = mysqli_query($conn,"select * from tb_category");   $jsArray = "var prdName = new Array();\n";   
                    echo '<select class="input-control" name="kategori" onchange="document.getElementById(\'prd_name\').value = prdName[this.value]" required>  <option>-Select Book Category-</option>';while ($row = mysqli_fetch_array($result)) {  echo ' <option value="' . $row['category_id'] . '">' . $row['category_name'] . '</option>';  
                   ...
                   <input type="text" name="nama" class="input-control" placeholder="Image Name" required>
