...
<body>
    ...
    <div class="section">
        <div class="container">
            <h3>Book Data</h3>
            <div class="box">
                <p><a href="tambah-image.php">Add Data</a></p>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <a href="proses-hapus.php?idp=<?php echo $row['image_id'] ?>" onclick="return confirm('Are You Sure to Delete This File ?')">Delete</a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
